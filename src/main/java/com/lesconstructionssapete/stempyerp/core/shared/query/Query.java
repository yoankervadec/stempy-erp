...
public enum Query {
  ...
  SELECT_CONFIG_ITEM_ENTRY_TYPE("config/select_config_item_entry_types.sql", false),
  SELECT_CONFIG_PAYMENT_METHOD("config/select_config_payment_methods.sql", false),
  SELECT_CONFIG_POS_TRANSACTION_TYPE("config/select_config_pos_transaction_types.sql", false),
  SELECT_CONFIG_RETAIL_CATEGORY("config/select_config_retail_categories.sql", false),
